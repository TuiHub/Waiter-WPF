namespace Commander.Forms
{
    ...
    partial class EditAppForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            label9 = new Label();
            label8 = new Label();
            iconImageUrlTextBox = new TextBox();
            label7 = new Label();
            ...
            heroImageUrlTextBox = new TextBox();
            tableLayoutPanel2 = new TableLayoutPanel();
            label10 = new Label();
            tagsNumTextBox = new TextBox();
            tagsEditButton = new Button();
            label11 = new Label();
            detailsEditButton = new Button();
            shortDescrptionTextBox = new TextBox();
            ...
            nameTextBox.Location = new Point(141, 123);
            ...
            // sourceUrlTextBox
            // 
            sourceUrlTextBox.Anchor = AnchorStyles.Left | AnchorStyles.Right;
            sourceUrlTextBox.Location = new Point(141, 93);
            sourceUrlTextBox.Margin = new Padding(3, 3, 30, 3);
            sourceUrlTextBox.Name = "sourceUrlTextBox";
            sourceUrlTextBox.Size = new Size(429, 23);
            sourceUrlTextBox.TabIndex = 3;
            // 
            // label4
            // 
            ...
            sourceComboBox.Items.AddRange(new object[] { "Internal", "Steam", "VNDB", "Bangumi", "Unspecified" });
            ...
            tableLayoutPanel2.Size = new Size(462, 30);
            ...
            // tagsNumTextBox
            // 
            tagsNumTextBox.Anchor = AnchorStyles.Left;
            tagsNumTextBox.Location = new Point(53, 3);
            tagsNumTextBox.Name = "tagsNumTextBox";
            tagsNumTextBox.ReadOnly = true;
            tagsNumTextBox.Size = new Size(40, 23);
            tagsNumTextBox.TabIndex = 1;
            tagsNumTextBox.TabStop = false;
            tagsNumTextBox.Text = "0";
            // 
            // tagsEditButton
            // 
            tagsEditButton.Anchor = AnchorStyles.Left;
            ...
            tableLayoutPanel3.Location = new Point(0, 570);
        ...
        private TextBox heroImageUrlTextBox;
        private Label label8;
        private TextBox iconImageUrlTextBox;
        private Label label7;
        private ComboBox typeComboBox;
        private Label label9;
        private TableLayoutPanel tableLayoutPanel2;
        private Label label10;
        private TextBox tagsNumTextBox;
        private Button tagsEditButton;
        private Label label12;
        private Label label11;
        private Button detailsEditButton;
        private TextBox shortDescrptionTextBox;
