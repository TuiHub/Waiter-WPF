...
using Wpf.Ui.Common;
using Wpf.Ui.Ext300.Common;
using Wpf.Ui.Ext300.Controls.IconElements;

namespace Wpf.Ui.Ext300.Controls.ContentDialogControl;
...
public class ContentDialog : ContentControl
{
    ...
    public static readonly DependencyProperty TemplateButtonCommandProperty =
        DependencyProperty.Register(nameof(TemplateButtonCommand),
            typeof(Common.IRelayCommand), typeof(ContentDialog), new PropertyMetadata(null));
